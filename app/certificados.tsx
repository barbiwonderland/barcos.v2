...
import { useEffect, useState } from 'react';import { Platform } from 'react-native';
            ...
            <View className="mb-2 mt-6 items-start">
              <TouchableOpacity
                ...
                <Text className="font-semibold text-[#0A1C34]">Agregar nuevo</Text>
                        ...
                        <ListPdf listElements={listElements} />

            </View>
          </View>
        </View>
      </Container>
      <ModalAddPdf listElements={listElements} setListElements={setListElements} selectedElement={selectedElement} setSelectedElement={setSelectedElement} setAddPdfModal={setAddPdfModal} addPdfModal={addPdfModal}/>
    </>
  );
}
